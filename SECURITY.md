...
Please do **not** disclose a suspected vulnerability in a public GitHub issue. Email `annunziata.mansker@gmail.com` with:

- the affected NoveMD version;
- the Windows version;
- a concise description and reproducible steps;
- the security impact you observed;
- supporting files that do not contain unrelated personal data.

请勿通过公开 GitHub Issue 披露疑似漏洞。请发送邮件至 `annunziata.mansker@gmail.com`，说明受影响的 NoveMD 与 Windows 版本、简要问题描述、可复现步骤、观察到的安全影响，以及不包含无关个人信息的必要证据。
